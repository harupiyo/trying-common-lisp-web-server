...
(ql:quickload '(:hunchentoot :cl-svg :cl-who :swank))
...
;;; making binary for deamonize
;;; Ref: https://blog.8arrow.org/entry/20120323/1332516342

(defun main ()
  (hunchentoot:start *acceptor*)
  (swank:create-server :port 4006 :style :spawn :dont-close t)  ; Swank using #4005 port in default. Change it 4006 for lead starting another standard swank session.
  ;; 起動を維持するために無限ループする
  (loop (sleep 60)))

(sb-ext:save-lisp-and-die "svg-server" :executable t :toplevel 'main)
